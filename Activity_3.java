...
public class Activity_3 {
  ...
  public void keep() throws InterruptedException {
	  ...
	  String reminder = driver.findElementByXPath("//androidx.cardview.widget.CardView[@content-desc=\"First. Abc. \"]/android.widget.LinearLayout/android.widget.LinearLayout/android.view.ViewGroup/android.widget.LinearLayout/android.widget.TextView").getText();
	  Assert.assertEquals(reminder, "Today, 2:00 PM");
